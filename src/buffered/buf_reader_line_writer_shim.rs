...
#[derive(Debug)]
pub(super) struct BufReaderLineWriterShim<'a, RW: Read + Write> {
    buffer: &'a mut BufReaderWriterBackend<RW>,
}

impl<'a, RW: Read + Write> BufReaderLineWriterShim<'a, RW> {
    #[inline]
    ...
    /// Get the content currently buffered in self.buffer's writer buffer
    #[inline]
...
impl<'a, RW: Read + Write> Write for BufReaderLineWriterShim<'a, RW> {
