...
/// ```
///
/// [`BufReaderWriter`]: crate::BufReaderWriter
pub struct BufReaderLineWriter<RW: Read + Write> {
...
struct BufReaderLineWriterBackend<RW: Read + Write> {
    inner: BufReaderWriterBackend<RW>,
}

impl<RW: Read + Write> BufReaderLineWriter<RW> {
...
impl<RW: Read + Write> BufReaderLineWriterBackend<RW> {
    pub fn new(inner: RW) -> Self {
...
impl<RW: Read + Write> Write for BufReaderLineWriter<RW> {
    #[inline]
...
impl<RW: Read + Write> Write for BufReaderLineWriterBackend<RW> {
    #[inline]
    fn write(&mut self, buf: &[u8]) -> io::Result<usize> {
...
impl<RW: Read + Write> Read for BufReaderLineWriter<RW> {
    #[inline]
...
impl<RW: Read + Write> Read for BufReaderLineWriterBackend<RW> {
    #[inline]
    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> {
        self.inner.read(buf)
    }
...
impl<RW: Read + Write> BufRead for BufReaderLineWriter<RW> {
    #[inline]
...
impl<RW: Read + Write> BufRead for BufReaderLineWriterBackend<RW> {
    #[inline]
    fn fill_buf(&mut self) -> io::Result<&[u8]> {
        self.inner.fill_buf()
    }
...
impl<RW: Read + Write> fmt::Debug for BufReaderLineWriter<RW>
where
    RW: fmt::Debug,
{
...
impl<RW: Read + Write> fmt::Debug for BufReaderLineWriterBackend<RW>
where
    RW: fmt::Debug,
{
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
