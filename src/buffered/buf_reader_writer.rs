...
///
/// ```no_run
/// use io_handles::BufReaderWriter;
/// use std::{io::prelude::*, net::TcpStream};
///
...
pub struct BufReaderWriter<RW: Read + Write> {
    inner: BufReaderWriterBackend<RW>,
}

pub(crate) struct BufReaderWriterBackend<RW: Read + Write> {
    inner: Option<RW>,
...
impl<RW: Read + Write> BufReaderWriter<RW> {
...
impl<RW: Read + Write> BufReaderWriterBackend<RW> {
    pub fn new(inner: RW) -> Self {
...
impl<RW: Read + Write> Write for BufReaderWriter<RW> {
    #[inline]
...
impl<RW: Read + Write> Write for BufReaderWriterBackend<RW> {
    fn write(&mut self, buf: &[u8]) -> io::Result<usize> {
...
impl<RW: Read + Write> Read for BufReaderWriter<RW> {
    #[inline]
...
impl<RW: Read + Write> Read for BufReaderWriterBackend<RW> {
    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> {
...
impl<RW: Read + Write> BufRead for BufReaderWriter<RW> {
    #[inline]
...
impl<RW: Read + Write> BufRead for BufReaderWriterBackend<RW> {
    fn fill_buf(&mut self) -> io::Result<&[u8]> {
...
impl<RW: Read + Write> fmt::Debug for BufReaderWriter<RW>
where
    RW: fmt::Debug,
{
...
impl<RW: Read + Write> fmt::Debug for BufReaderWriterBackend<RW>
where
    RW: fmt::Debug,
{
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
...
impl<RW: Read + Write> Drop for BufReaderWriterBackend<RW> {
    fn drop(&mut self) {
